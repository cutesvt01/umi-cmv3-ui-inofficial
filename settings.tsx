...
export const mintText = [
  ...
  { label: "default", mintText: "Minting price: 0.05 SOL (+fees)", buttonLabel: "Mint now!", header: "Default"}
];

//header image in the ui. replace with your own
export const image = "https://i.imgur.com/wt2CW71.png";

//website title
export const headerText = "Solana Tigers";
